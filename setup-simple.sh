...
echo ""
echo "2. Configura AWS Cognito:"
echo "   - Ve a https://aws.amazon.com/"
echo "   - Crea una cuenta (capa gratuita)"
echo "   - Busca 'Cognito' en la consola"
echo "   - Crea un User Pool"
echo "   - Anota el Pool ID y Client ID"
echo "   - Edita frontend/.env.local"
echo ""
